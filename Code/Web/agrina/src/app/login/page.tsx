  ...
  return (
    <main className="min-h-[100dvh] bg-white flex items-start md:items-center justify-center p-6">
      <div className="w-full max-w-md space-y-6">
        ...
        <section className="rounded-xl bg-white shadow-xl ring-1 ring-[color:var(--color-line)]">
            ...
            {tab === "signin" ? (
              <>
                {signInState?.ok === false && (
                  <p className="mb-3 rounded-md bg-red-50 px-3 py-2 text-sm text-red-600 ring-1 ring-red-200">
                    {signInState.message}
                  </p>
                )}
                <form action={signInFormAction} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full h-11 rounded-xl bg-[color:var(--color-brand)] text-white text-sm font-semibold shadow-sm hover:bg-[color:var(--color-brand-hover)] disabled:opacity-70"
                  >
              ...
              <>
                {signUpState?.message && (
                  <p
                    className={`mb-3 rounded-md px-3 py-2 text-sm ring-1 ${
                      signUpState.ok
    ...
    <label className="block">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full h-11 rounded-xl border border-[color:var(--color-line)] bg-zinc-50 pl-10 pr-3 text-[15px] outline-none placeholder:text-zinc-500 focus:border-[color:var(--color-brand)] focus:bg-white"
          required
        />
      </div>
    </label>
